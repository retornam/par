...
char **reformat(
  ...
  /* including endline.  The other parameters are the variables of  */
  /* the same name as described in "par.doc".  reformat(inlines,    */
  /* endline, hang, prefix, suffix, width, fit, guess, just, last,  */
